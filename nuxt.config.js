  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'author', name: 'author', content: 'Geekait' },
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://geekait.netlify.app/' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:title', content: 'Movies' },
      { name: 'twitter:description', content: 'Browse Movies, TV Shows and People' },
      { name: 'twitter:site', content: 'geekait' },
      { name: 'twitter:creator', content: 'geekait' },
      { name: 'twitter:image', content: 'https://geekait.netlify.app/icon-medium.png' },
    ],
    link: [
